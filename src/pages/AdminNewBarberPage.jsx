...
import { useGetProfileQuery, useCreateBarberMutation, useGetBarbershopsQuery } from '../store/apiSlice';
...
const AdminNewBarberPage = () => {
    ...
    const [createBarber, { isLoading: isSubmitting }] = useCreateBarberMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await createBarber(formData).unwrap();
            ...
            console.error('Не удалось создать барбера:', err);
            setError('Ошибка при создании барбера. Пожалуйста, попробуйте позже или измените данные (email и телефон должны быть уникальными).');
        }
    };
        ...
        >
            ...
            {success && (
                <Alert severity="success" sx={{ mb: 2 }}>
                    Барбер успешно создан! Вы будете перенаправлены на главную страницу.
                </Alert>
            )}
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end' }}>
                            ...
                            >
                                {isSubmitting ? 'Создание...' : 'Создать барбера'}
                            </Button>
                        </Box>
                    </Grid>
                </Grid>
...
export default AdminNewBarberPage; 